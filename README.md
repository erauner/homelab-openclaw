...
{
  "skills": {
    "allowBundled": ["obsidian", "github", "bluebubbles", "skill-creator", "weather"],
    "entries": {
...
- The obsidian skill uses direct file access (not `obsidian-cli`) since there's no Obsidian desktop app
- All configuration is GitOps-managed via the values.yaml in homelab-k8s
